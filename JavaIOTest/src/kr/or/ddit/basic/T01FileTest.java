...
public class T01FileTest {
	public static void main(String[] args) throws IOException {
		...
		//		구분문자는 '\' 또는  '/' 를 사용할 수 있다.
		File file = new File("d:\\D_Other\\test.txt"); //파일을 생성한 게 아니고 파일 객체를 생성
		System.out.println("파일명: " + file.getName()); //왜 역슬래시를 두번했음?
		...
		// => 'parent' 디렉토리 안에 있는 'child' 파일 또는 디렉토를 갖는다
		...
		//. 현재위치 .. 상위 위치
		System.out.println("절대 경로: " + file4.getPath());
		...
		File file5 = new File("d:/D_Oher/연습용");
		if(file5.mkdir()) {
