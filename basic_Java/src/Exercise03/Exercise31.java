...
public class Exercise31 {
	...
	public static void main(String[] args) {
		...
		//처리
		int bigNum = ((num1 + num2) + Math.abs(num1-num2)) /2 ; //큰 수
		int smallNum = ((num1 + num2) - Math.abs(num1-num2)) /2 ; //작은 수
		int mok = (int)(bigNum/smallNum);
		int namage = (int)(bigNum%smallNum);
		
		//출력
		System.out.println("큰 수를 작은 수로 나눈 몫은 " + mok + "이고," 
							+ "나머지는" + namage + "이다.");
