...
public class T03DOMParsingExam {
	public void parse() throws Exception {
		...
		String recipeId = "433"; // 래시피가 궁금한 음식 ID
...
//  		System.out.println(url.toString());
		...
		if(code.equals("INFO-000")) { //정상상태인 경우...
			...
			for(int i=0; i<rowNodeList.getLength(); i++) {
				...
				String rowNum = 
						element.getElementsByTagName("ROW_NUM")
						.item(0).getTextContent();
				String irdntNm = 
						element.getElementsByTagName("IRDNT_NM")
						.item(0).getTextContent();
				String irdntCpcty = 
				...
				System.out.printf("%3s %8s %10s %10s %8s\n"
								,rowNum, recipeId, irdntyNm, irdntNm, irdntCpcty);
				System.out.println("============================================================");
			}
