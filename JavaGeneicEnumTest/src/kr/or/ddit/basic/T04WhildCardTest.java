...
public class T04WhildCardTest {
	 ...
	 * 특별한 종류의 인수(Argument)로서 변수선언, 객체생성 및
	 * 메서드 정의 할 때 사용된다. (제너릭 타입 선언시에는 사용할 수 없다)
	 * 
	 * <? extends T> => 와일드 카드의 상한 제한. T와 그 자손들만 가능 
	 * <? super T> => 와일드 카드의 하한 제한. T와그 조상들만 가능. 
	 * <?> => 허용가능한 모든 타입이 가능 <? extends Object> 와 동일
	 * 
	 */
